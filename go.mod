module github.com/streamingfast/firehose-gear
...
replace github.com/centrifuge/go-substrate-rpc-client/v4 => github.com/streamingfast/go-substrate-rpc-client/v4 v4.0.0-20240730223728-a684c50db2db
