...
func to_GearVoucher_UpdateCall(fields []*registry.DecodedField) *pbgear.GearVoucher_UpdateCall {
    return &pbgear.GearVoucher_UpdateCall{
        ...
        ProlongDuration : uint32(fields[6].Value),
            ...
            func to_optional_GearVoucher_string(in *registry.DecodedField) *string {
                var out *string
            ...
            func to_optional_GearVoucher_bool(in *registry.DecodedField) *bool {
                var out *bool

                if v, ok := in.Value.(bool); ok {
                    if v != false {
                        panic("expected none")
                    }
                } else {
            ...
            func to_optional_GearVoucher_uint32(in *registry.DecodedField) *uint32 {
                var out *uint32
